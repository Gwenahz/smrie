...
class HelpsControllerTest < ActionController::TestCase
  ...
  test "should create help" do
    assert_difference('Help.count') do
      post :create, help: { cp: @help.cp, mail: @help.mail, modele: @help.modele, nom: @help.nom, numtel: @help.numtel, panne: @help.panne, prenom: @help.prenom }
    end
  ...
  test "should update help" do
    patch :update, id: @help, help: { cp: @help.cp, mail: @help.mail, modele: @help.modele, nom: @help.nom, numtel: @help.numtel, panne: @help.panne, prenom: @help.prenom }
    assert_redirected_to help_path(assigns(:help))
  end
