...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { adresse: @info.adresse, cp: @info.cp, nom: @info.nom, prenom: @info.prenom, ville: @info.ville }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { adresse: @info.adresse, cp: @info.cp, nom: @info.nom, prenom: @info.prenom, ville: @info.ville }
    assert_redirected_to info_path(assigns(:info))
  end
