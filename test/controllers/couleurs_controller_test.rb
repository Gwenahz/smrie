...
class CouleursControllerTest < ActionController::TestCase
  ...
  test "should create couleur" do
    assert_difference('Couleur.count') do
      post :create, couleur: { code: @couleur.code, couleur: @couleur.couleur, smartphone: @couleur.smartphone }
    end
  ...
  test "should update couleur" do
    patch :update, id: @couleur, couleur: { code: @couleur.code, couleur: @couleur.couleur, smartphone: @couleur.smartphone }
    assert_redirected_to couleur_path(assigns(:couleur))
  end
