...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { id_panne: @price.id_panne, id_smartphone: @price.id_smartphone, prix: @price.prix }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { id_panne: @price.id_panne, id_smartphone: @price.id_smartphone, prix: @price.prix }
    assert_redirected_to price_path(assigns(:price))
  end
