...
class SmartphonesControllerTest < ActionController::TestCase
  ...
  test "should create smartphone" do
    assert_difference('Smartphone.count') do
      post :create, smartphone: { couleur: @smartphone.couleur, marque: @smartphone.marque, modele: @smartphone.modele }
    end
  ...
  test "should update smartphone" do
    patch :update, id: @smartphone, smartphone: { couleur: @smartphone.couleur, marque: @smartphone.marque, modele: @smartphone.modele }
    assert_redirected_to smartphone_path(assigns(:smartphone))
  end
